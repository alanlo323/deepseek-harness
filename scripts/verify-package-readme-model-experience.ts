...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/document/document-core': { kind: 'none', reason: 'Shared path, containment, and snapshot helpers; dsh-tool-present-document owns the model-facing schema and result.' },
  'packages/document/document-host': { kind: 'none', reason: 'Host projection, live Remote, and image Fetch for already-submitted documents; the present_document tool owns every model-facing contract.' },
