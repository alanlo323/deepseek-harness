...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  ReadSubmittedDocumentFailure: 'document.md',
  ReadSubmittedDocumentFailureCode: 'document.md',
  ReadSubmittedDocumentRequest: 'document.md',
  ReadSubmittedDocumentResult: 'document.md',
  ReadSubmittedDocumentValue: 'document.md',
  ...
  BrowserSessionId: 'browser.md',
  BrowserSessionMeta: 'browser.md',
  BrowserSessionView: 'browser.md',
  ScreencastFrame: 'browser.md',
  ScreencastRequest: 'browser.md',
