...
import { en as conversationEn, NS as CONVERSATION_NS, zh as conversationZh, zhHant as conversationZhHant } from '@deepseek-ai/dsh-client-ui-conversation/src/client/locales.ts'
...
async function bench(snapshot: ChatSnapshot) {
  ...
  locale.register(CONVERSATION_NS, { zh: conversationZh, en: conversationEn, 'zh-Hant': conversationZhHant })
