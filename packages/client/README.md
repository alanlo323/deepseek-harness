...
| [`ui-document/`](ui-document/README.md) | Presents submitted Markdown reports in a Report conversation view | — |
| [`ui-browser/`](ui-browser/README.md) | Presents the watch-only Browser Session viewport column | — |
