...
export const en = {
  ...
  maxImagesPerRequestPlaceholder: 'No limit',
  ...
  modelMaxImagesInvalid: 'Max images per request must be a positive whole number, like 1 or 8.',
  ...
  modelMaxImagesPerRequest: 'Max images per request',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  maxImagesPerRequest: '单次最多图片',
  maxImagesPerRequestPlaceholder: '不限制',
  modelAdvanced: '容量',
  addModel: '添加模型',
  removeModel: '删除模型',
  ...
  modelMaxImagesInvalid: '单次最多图片必须是正整数，例如 1 或 8。',
  ...
  modelMaxImagesPerRequest: '单次最多图片',
  fetchModels: '获取可用模型',
  fetching: '正在询问提供方\u2026',
...
export const zhHant = {
  ...
  modelMaxImagesInvalid: '單次最多圖片必須是正整數，例如 1 或 8。',
  ...
  modelMaxImagesPerRequest: '單次最多圖片',
  fetchModels: '獲取可用模型',
  fetching: '正在詢問提供方\u2026',
