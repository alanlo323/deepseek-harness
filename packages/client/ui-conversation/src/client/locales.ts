...
const PLAN_NEXT_ACTION_ZH_HANT = '描述你的任務以生成計劃'
...
export const zh = {
  ...
  'settings.thinkPreview.title': '折叠 Think 摘要',
  'settings.thinkPreview.description': '仅在思考进行且未展开时生效；默认显示当前段落开头，也可跟随最新字符',
  'settings.thinkPreview.prefix': '段落开头',
  'settings.thinkPreview.followEnd': '跟随最新字符',
  ...
  'search.shownOfTotal': '显示 {shown} / 共 {total}',
  'search.paths': '{count} 个路径',
...
export const zhHant = {
  'view.chat': '對話',
  'hint.plan': PLAN_NEXT_ACTION_ZH_HANT,
  'hint.goal': '輸入目標，智能體將持續執行',
  'hint.goal.active': '當前目標進行中。可輸入 edit 修改 / pause 暫停 / resume 繼續 / clear 清除',
  'placeholder.plan': PLAN_NEXT_ACTION_ZH_HANT,
  'placeholder.default': '給智能體發消息',
  ...
  'image.sendFailed': '圖片發送失敗（{reason}），請重新添加圖片後再試',
  'context.aria': '上下文已用 {percent}',
  'context.used': '上下文已用',
  ...
  'settings.thinkPreview.title': '摺疊 Think 摘要',
  'settings.thinkPreview.description': '僅在思考進行且未展開時生效；預設顯示目前段落開頭，也可跟隨最新字元',
  'settings.thinkPreview.prefix': '段落開頭',
  'settings.thinkPreview.followEnd': '跟隨最新字元',
  'access.confirm.title': '確認啟用 Full access？',
  'access.confirm.description': '啟用 Full access 後，agent 將減少確認步驟，並且可以直接執行更多操作，包括敏感操作、檔案修改或外部命令。僅建議在你信任當前任務時使用。',
  ...
  'details.title': '詳情',
  'details.close': '關閉詳情',
  'details.empty': '點擊消息流中的工具行查看詳情',
  'details.notInWindow': '該調用不在當前窗口內',
  'details.input': '輸入',
  'details.output': '輸出',
  'details.running': '運行中…',
  'todo.title': '任務',
  ...
  'chat.loadOlder': '載入更早',
  'chat.toBottom': '回到底部',
  'fileOpen.title': '無法打開檔案',
  'fileOpen.unknown': '無法打開此檔案',
  'fileOpen.folderTitle': '無法打開資料夾',
  'fileOpen.folderUnknown': '無法打開此資料夾',
  ...
  'message.branchUnavailable': '僅可從已完成輪次的最後一條消息分支',
  ...
  'queue.count': '{n} 條排隊消息',
  'queue.edit': '編輯排隊消息',
  'queue.edit.unsupported': '包含非文本內容，暫不支援編輯',
  'queue.save': '儲存排隊消息',
  ...
  'diff.collapseAria': '收合差異',
  'diff.expandAria': '展開其餘 {n} 行差異',
  'diff.expandRest': '… 其餘 {n} 行',
  'read.showing': '顯示 {shown} / {total} 行',
  'read.collapseAria': '收合內容',
  'read.expandAria': '展開其餘 {n} 行',
  'read.expandRest': '… 其餘 {n} 行',
  'search.shownOfTotal': '顯示 {shown} / 共 {total}',
  'search.paths': '{count} 個路徑',
  'search.matches': '{count} 處匹配 · {files} 個檔案',
  'search.empty': '無結果',
  'search.collapseAria': '收合結果',
  'search.expandAria': '展開其餘 {n} 行結果',
  'search.expandRest': '… 其餘 {n} 行',
  'web.noResults': '未找到結果',
...
export const en = {
  ...
  'settings.thinkPreview.title': 'Collapsed Think summary',
  'settings.thinkPreview.description': 'While thinking and collapsed: show the current paragraph start, or follow the latest characters',
  'settings.thinkPreview.prefix': 'Paragraph start',
  'settings.thinkPreview.followEnd': 'Follow latest characters',
  ...
  'search.shownOfTotal': 'Showing {shown} / {total}',
  'search.paths': '{count} paths',
