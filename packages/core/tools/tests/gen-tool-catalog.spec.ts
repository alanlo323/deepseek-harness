...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      'ask_user_question', 'bash', 'bash', 'browser_close', 'browser_open', 'browser_run', 'cordis_define', 'cordis_inspect_list',
      ...
      'list_agents', 'list_agents', 'list_subagent_models', 'lsp', 'present_document', 'pwsh', 'pwsh', 'ralph',
