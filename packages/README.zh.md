...
| [`browser/`](browser/README.zh.md) | 无头 Chromium Browser Session：seam、Playwright 提供方、工具、Web 视口 |
| [`document/`](document/README.zh.md) | 已提交 Markdown 报告：present_document、宿主投影与 Web 报告视图 |
