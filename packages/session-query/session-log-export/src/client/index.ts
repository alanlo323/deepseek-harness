...
import { en, NS, zh, zhHant, type SessionLogDownloadKey } from './locales.ts'
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(() => ctx.locale.register(NS, { zh, en, 'zh-Hant': zhHant }), 'session-log-download: browser dictionaries')
