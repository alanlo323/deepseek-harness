...
import submittedDocumentRemote from '@deepseek-ai/dsh-document-host/remote'
import browserRemote from '@deepseek-ai/dsh-browser-host/remote'
...
export type {} from '@deepseek-ai/dsh-document-host/remote'
export type {} from '@deepseek-ai/dsh-browser-host/remote'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      pluginInventoryRemote, messageFeedbackRemote, submittedDocumentRemote, browserRemote, sessionReferencesRemote,
