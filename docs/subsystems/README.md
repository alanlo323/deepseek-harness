...
| [document.md](document.md) | submitted Markdown reports: present_document snapshot, host projection records, and live-read Remote types |
...
| [browser.md](browser.md) | the headless Chromium Browser Session: occupancy, `browser-session` meta, JPEG screencast frames, watch-only Host Remote |
