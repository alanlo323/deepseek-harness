...
| [document.md](document.zh.md) | 已提交 Markdown 报告：present_document 快照、宿主投影记录与实时读取 Remote 类型 |
...
| [browser.md](browser.zh.md) | 无头 Chromium Browser Session：占用、`browser-session` meta、JPEG 投屏帧、仅供观看的 Host Remote |
