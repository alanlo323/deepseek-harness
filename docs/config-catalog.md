...
Source: [`packages/browser/browser-playwright/src/config.ts:9`](../packages/browser/browser-playwright/src/config.ts)
...
- `@deepseek-ai/dsh-browser-host` — requires `sessionProjections` · `sessions` · `browser` ([`packages/browser/browser-host/src/index.ts`](../packages/browser/browser-host/src/index.ts))
...
- `@deepseek-ai/dsh-tool-browser` — requires `tools` · `browser` · `systemPrompt` ([`packages/browser/tool-browser/src/index.ts`](../packages/browser/tool-browser/src/index.ts))
