...
Horizontal layout reads and writes for the collapsed Think summary run at most once every three frames, and each update moves the summary directly to the latest position; React still commits accumulated snapshots normally, and settlement keeps the last paragraph at the left edge ([settled last-paragraph decision](../feature/2026-08-20-web-thinking-settled-last-paragraph.md)). This local visual policy does not change the immediacy of body scrolling or user interactions.
